...
public class ViewSWTComponent extends AbstractSWTLocatable<SWTBotView>
		implements SWTWorkbenchComponent<SWTBotView> {

	private final String viewTitle;
	private final SWTRootComponent<SWTWorkbenchBot> parent;

	public ViewSWTComponent(final String viewTitle,
			final SWTRootComponent<SWTWorkbenchBot> parent) {
