...
public class SubstepsTestParentElement extends AbstractSubstepsTestElement implements SubstepsTestElementContainer {

    private final List<SubstepsTestElement> children;
    private Status childrenStatus;


    public SubstepsTestParentElement(final SubstepsTestParentElement parent, final String id, final String testName,
            final int testCount) {
