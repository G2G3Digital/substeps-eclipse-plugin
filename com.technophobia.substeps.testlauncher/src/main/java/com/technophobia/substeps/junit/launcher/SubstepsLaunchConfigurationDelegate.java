...
public class SubstepsLaunchConfigurationDelegate extends AbstractJavaLaunchConfigurationDelegate {
     ...
     */
    @Override
    public synchronized void launch(final ILaunchConfiguration configuration, String mode, final ILaunch launch,
        ...
        try {
            ...
            final Map<String, String> vmAttributesMap = getVMSpecificAttributesMap(configuration);
